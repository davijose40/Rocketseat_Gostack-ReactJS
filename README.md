...
<!-- summary -->
This is a simple Front-end view connecting with backend using API
...
`<git clone https://github.com/davijose40/Rocketseat_Gostack-ReactJS.git>`, then in the folder **Rocketseat_Gostack-ReactJS*** run `<yarn>` and you are good to go!
